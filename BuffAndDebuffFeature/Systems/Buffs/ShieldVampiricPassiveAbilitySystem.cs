...
{
    [Serializable]
    [Documentation(Doc.Buff, Doc.PassiveAbilities, "ShieldVampiricPassiveAbilitySystem")]
    public sealed class ShieldVampiricPassiveAbilitySystem : BaseWeaponPassiveAbilitySystem
    {
        ...
        private void AddBuffToWeapon(Entity ability)
        {
            ...
            var vampiricTag = ability.GetOrAddComponent<ShieldVampiricTagComponent>();

            if (countersHolder.TryGetCounter<ICounterModifiable<float>>(CounterIdentifierContainerMap.ShieldVampiricPower, out var counter))
            {
        ...
        {
            var countersHolder = ability.GetComponent<CountersHolderComponent>();
            var vampiricTag = ability.GetComponent<ShieldVampiricTagComponent>();
        ...
        public override void InitSystem()
        {
            ...
            var modifier = new DefaultFloatModifier
            {
                ...
                ModifierCounterID = CounterIdentifierContainerMap.ShieldVampiricPower
            };
