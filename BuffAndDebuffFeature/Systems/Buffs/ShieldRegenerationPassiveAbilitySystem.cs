...
namespace Systems
{
    [Serializable][Documentation(Doc.Buff, Doc.PassiveAbilities, "ShieldRegenerationPassiveAbilitySystem")]
    public sealed class ShieldRegenerationPassiveAbilitySystem : BasePassiveAbilitySystem
    {
        ...
        private void ActivateBuff()
        {
            ...
            if (shieldCountersHolder.TryGetCounter<ICounterModifiable<float>>(CounterIdentifierContainerMap.ShieldRegenerationPower, out var counter))
            {
        ...
        public override void InitSystem()
        {
            ...
            var modifier = new DefaultFloatModifier
            {
                ...
                ModifierCounterID = CounterIdentifierContainerMap.ShieldRegenerationPower
            };
